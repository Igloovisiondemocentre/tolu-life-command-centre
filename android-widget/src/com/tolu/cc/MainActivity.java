...
public class MainActivity extends Activity {
    ...
    private void requestWidgetPinOnce() {
        ...
        if (WidgetStore.prefs(this).getBoolean("pin_requested", false)) return;
        ...
        try {
            ...
            if (((Boolean)request.invoke(manager, provider, null, callback)).booleanValue()) WidgetStore.prefs(this).edit().putBoolean("pin_requested", true).apply();
